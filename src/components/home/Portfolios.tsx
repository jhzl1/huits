...
const Portfolios = forwardRef((_, ref) => {
  ...
  const EnglishInfo = () => <a href="https://beverlyhuit.huitinvestment.com/english">More Info</a>;

  const SpanishInfo = () => <a href="https://beverlyhuit.huitinvestment.com/español">Más Información</a>;

  const MoreInfoTextEn = () => <a href="/ourportfolio">More Info</a>;

  const MoreInfoTextEs = () => <a href="/ourportfolio">Más Información</a>;
