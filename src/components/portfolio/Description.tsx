  ...
  return (
    <div className="text-white mb-7 md:mb-20">
      ...
      <div className="md:py-28 grid grid-cols-1  lg:grid-cols-2">
        ...
        />
        <div className="px-6 md:px-24 py-10"><h2 className="text-[#8108B9] text-5xl md:text-6xl mb-10">{t("portfolio.composition.title")}</h2>
      ...
      <div className="md:py-18 grid grid-cols-1  lg:grid-cols-1">
        <div className="px-6 md:px-24 py-10"><h2 className="text-white text-5xl md:text-6xl mb-10">{t("portfolio.historicchange.title")}</h2>
          <div className="bg-black w-[1000px] sm:w-[900px] text-center sm:text-5xl font-bold bg-opacity-50 border-4 rounded-3xl border-purple-800 ml-auto mr-auto ">
          <img
            src={require("assets/img/historicprofit.png")}
            alt=""
            className="ml-auto mr-auto h-[200px] w-[300px] sm:w-[600px] sm:h-[300px] md:h-[500px]"
        />
          </div>
        </div>
      </div>     
      <div className="md:py-14 grid grid-cols-2  lg:grid-cols-2">
      <div className="ml-44 md:ml-3 mt-34 md:mt-24 mb-10 md:mb-0 w-[300px] sm:w-[600px]">
      </div>
        <div className="px-6 md:px-24 py-10">
